...
#define ZB_LIGHT_BULB_IN_CLUSTER_NUM 4    /* server: Basic + Identify + On/Off clusters + Temperature */
...
ZB_DECLARE_SIMPLE_DESC(4, 0); /* 4 cluster description in one array (basic, identify, on/off, temperature)*/
...
ZB_ZCL_TEMP_MEASUREMENT_REPORT_ATTR_COUNT, reporting_info##ep_name, \
0, NULL)
