...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_TIME_KTIMER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CRACEN_ECDH_MONTGOMERY_255, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CRACEN_ECDH_MONTGOMERY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CRACEN_KEY_TYPE_ECC_KEY_PAIR_DERIVE_MONTGOMERY_255, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_DPPI20, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_PPIB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_PPIB11, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_PPIB21, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_BTZ_ENDDEVICE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_BTZ_ENDDEVICE_NRF54L15_CPUAPP, 1);
